...
<body>
    <nav>
        ...
        <ul>
            ...
            <?php if ($display_name) { ?>
                <li style="color: black; font-weight: bold;">Welcome Back, <?php echo htmlspecialchars($display_name); ?></li>
                <li>
                ...
                <li><a href="logout.php" style="color: white; background: #2563EB; border-radius: 10px; font-size: large; padding: 5px 15px;">Logout</a></li>
            <?php } else { ?>
